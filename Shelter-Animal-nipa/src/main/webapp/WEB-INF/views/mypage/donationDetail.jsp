...
<!-- 		<div class="col-sm-6" style="float:left;"> -->
    ...
    <div class="row">
		...
		<button type="button" class="btn btn-default" data-toggle="modal" data-target="#dntModal">후원하기</button>
		...
		<div style="text-align:center; margin-top:2%; margin-bottom:2%">
					...
					<img src="../img/do3.jpg" style="margin-top:5%; margin-bottom:5%; width:80%; height:60%" >
					<img src="../img/do4.jpg" style="margin-top:5%; margin-bottom:5%; width:80%; height:60%">
