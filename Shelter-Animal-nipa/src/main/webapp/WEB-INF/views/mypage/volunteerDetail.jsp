	...
	<div style="margin-top:10%">
	  ...
	  <p style="text-align:left">2018-10-09 17.06.15 조회수 : 1</p>
	   ...
	   <div style="margin-left:85%" >
		<button class="button button1">신청하기</button></div>
		</div>
	   <img src="img/vol1.jpg" style="margin-top:5%; margin-bottom:5%; width:60%; ">
	   <p>괴산 보호소에는 연세 많으신 두 분께서
		200여마리의 아이들을 돌보고 계십니다.</p>
	   <img src="img/vol2.jpg" style="margin-top:5%; margin-bottom:5%; width:60%; ">
	   <p>아픈아이들과 노령견, 소형견, 중형견, 대형견,
			그리고 친한 아이들과 독립적인 아이들로 나눠
			각자의 공간 또는 한 공간에서
			최대한 자유롭게 살 수 있도록 돌봐주고자 노력하고 있습니다.</p>
	   <img src="img/vol3.jpg" style="margin-top:5%; margin-bottom:5%; width:60%; ">
	   <p>아픈 아이들과 소형견 아이들을 위한 아지피아,
			야외활동 하는 대형견 아이들을 위한 특수견 플러스,
			거실에서 활동하는 고양이들과,
			소문 듣고 몰려온 동네 길냥이들을 위한
			고양이 사료와 캔이 늘 필요합니다.</p>
	   <img src="img/vol4.jpg" style="margin-top:5%; margin-bottom:5%; width:60%; ">
	   <p>봉사를 원하시는 분들은
		위의 전화번호로 아부지님과 일정 상의 후 방문해 주시면 되구요.
		미용봉사, 목욕봉사, 청소봉사 ~
		그냥 아이들 만나러 오셔도~
		언제든 환영입니다.</p>
