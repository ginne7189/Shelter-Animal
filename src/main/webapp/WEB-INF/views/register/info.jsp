      ...
      <form name="register_form" method="post" action="${root }/infolist.animal" id="register_form"
         ...
         <table style="margin-left:auto; margin-right:auto; cellspacing:20">
               ...
               <tr style="height: 25px;">
                  ...
                  <td >
                  <input   class="form-control email" type="email" id="email" size="54" required onblur="javascript:emailCheck()"
                	  value="${info.email}"  readonly name="email" maxlength="30" style="width:320px; height:45px;"></td>
               </tr>
               <tr>
                  <td colspan="2">
