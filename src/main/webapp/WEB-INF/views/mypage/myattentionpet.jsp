	...
	<script>
		...
		function makeList(data) {
			...
			for (var i = 0; i < members.length; i++) {
				...
				viewlist += "</h4>";
				viewlist += "<p class='card-text'>	 <b>품종 :</b> "
						+ members[i].kind + "</p>";
				viewlist += "<p class='card-text'>	 <b>나이 :</b> "
						+ members[i].age + "	</p>";
				viewlist += "<p class='card-text'>	 <b>체중 :</b> "
						+ members[i].weight + "	</p>";
				viewlist += "<p class='card-text'>	 <b>위치 :</b> "
						+ members[i].location + "	</p>";
				viewlist += "</div>";
				viewlist += "</div>";
			}
...
<body style="background-color: #EEEEEE; padding: 0px; margin: 0px;">
	...
	<div class="container">
		...
		<div class="row" id="main" style="padding: 0px; margin: 0px;"></div>
