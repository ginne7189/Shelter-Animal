	...
	<div class="container-fluid" style="width: 48%; display: inline-block; text-align: center; margin-left: 26%; margin-top: 2%;">
		...
		<div class="carousel-item active">
			<div style="margin-left: 85%">
				<button class="button button1">분양하기</button>
			</div>
		</div>
		<img src="img/p1.jpg" style="margin-top: 5%; margin-bottom: 5%; width: 60%;">
		<p>오늘도 많은 아이들이 각자의 안타까운 사연을 가지고 찾아오게 되었습니다. 영덕동물보호센터에 새로 들어오게 된 아이입니다.</p>
		<img src="img/p2.jpg" style="margin-top: 5%; margin-bottom: 5%; width: 60%;">
		<p>파양동물 입양시 소정의 책임비가 발생되니 참고부탁드립니다. 아이들의 평생을 결정하는 선택.신중히 생각해 보신 후에 연락주세요.</p>
		<img src="img/p3.jpg" style="margin-top: 5%; margin-bottom: 5%; width: 60%;">
		<p>영덕동물보호센터에서 보호관리 중인 보호동물 아이들은 유동적인 부분이 많아 전화.상담을 통해 확인이 어려운 점 양해드리며 매장 방문 하시면 더 많은 아이들을 만날 수 있습니다.</p>
