		...
		function makeList(data) {
			...
			for (var i = 0; i < members.length; i++) {
				if (i % 2 == 0) {
					...
					viewlist += "<p><b> 목표 후원 금액 </b> : "
							+ members[i].cdonationfee + "</p>";
					viewlist += "<hr>";
					...
					viewlist += "<div class='progress-bar progress-bar-striped progress-bar-animated' style='width:"
							+ members[i].gatheringfee
							/ members[i].cdonationfee
							* 100 + "%'>" + members[i].gatheringfee + "</div>";
					viewlist += "</div>";
					viewlist += "</div>";
