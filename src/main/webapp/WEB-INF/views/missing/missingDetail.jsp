...
<body style="background-color: #EEEEEE; padding: 0px; margin: 0px;">
	...
	<div class="container-fluid" style="width: 48%; display: inline-block; text-align: center; margin-left: 26%; margin-top: 2%;">
		...
		<div class="carousel-item active">
			...
			<img src="img/cat1.jpg" style="margin-bottom: 10%; width: 60%;"> <img src="img/cat2.jpg" style="margin-bottom: 10%; width: 60%;"> <img src="img/cat3.jpg" style="margin-bottom: 10%; width: 60%;"> <img src="img/cat4.jpg" style="margin-bottom: 10%; width: 60%;">
		</div>


		<p>
			★실종날짜 : 2017-12-28<br> ★실종지역:서울 강남구 대치동 미도아파트 2단지 10월2일저녁 10시 40 분 대치동 미도아파트 세븐일레븐방향으로 뛰어감/대치동에 사는 강아지가 아닌데 대치동에서 잃어버림. 보호중이시거나 목격하시면 제보 부탁드립니다. 주변에 전단지퍼날라주세요. 감사합니다.
		</p>
		<hr>
		<!-- 구글맵 -->
