...
<%@include file="../common/header.jsp"%>
	<div align="center">
		<form name="pwdReset_form" method="post" action="${root }/pwdReset.animal?email=<%=email %>" id="pwdReset_form"
         onsubmit="return checkResetPwd()">
			비밀번호 입력 <input type="password" id="pwd" name="pwd" value="" maxlength="16" size="54"
                     placeholder="패스워드" pattern=".{8,16}" required maxlength="16" title="8 to 16 characters" onkeyup="javascript:pwdLengthCheck()"
                  style="width:320px; height:45px;"><br>
			비밀번호 확인 <input type="password" id="pwdChk" name="pwdChk" value="" maxlength="16" size="54"
                     placeholder="비밀번호 확인" required maxlength="16" onkeyup="javascript:pwdSameChk()"
                  style="width:320px; height:45px;"><br>
			<p class="register_advise pwd_check" style="text-align:center; color: red;"></p><br>
			<button type="submit" name="btn_resetPwd" style="margin-left:60px; width:450px; height:50px;"><font size="5"><b>비밀번호변경</b></font></button>
		</form>
	</div>
</body>
</html>