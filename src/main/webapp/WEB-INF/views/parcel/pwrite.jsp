...
<div class="container allDiv">
	...
	<div class="w3-row-padding">
	  ...
	  <div class="w3-half">
	    <label>품종</label>
	    <input class="w3-input" type="text" id="kind" name="kind" placeholder="분양하실 동물의 품종을 입력해주세요">
	  </div>
	  <div class="w3-half">
	    <label>나이</label>
	    <input class="w3-input" type="text" id="age" name="age" placeholder="분양하실 동물의 나이를 입력해주세요">
	  </div>
	  
	  <div class="w3-half">
	    <label>성별</label>
	    <input class="w3-input" type="text" id="gender" name="gender" placeholder="분양하실 동물의 성별을 입력해주세요">
	  </div>
	  <div class="w3-half">
	    <label>지역</label>
	  ...
	  <div class="w3-half">
	    <label>체중</label>
	    <input class="w3-input" type="text" id="weight" name="weight" placeholder="분양하실 동물의 체중을 입력해주세요">
	  </div>
	  <div class="w3-half">
	    <label>특징</label>
	    <input class="w3-input" type="text" id="feature" name="feature" placeholder="분양하실 동물의 특징을 입력해주세요">
	  </div>
