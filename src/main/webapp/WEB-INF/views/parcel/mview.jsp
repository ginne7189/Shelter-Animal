		...
		$.ajax({
			...
			success : function(data) {
				$.each(data.replyValue, function(key, value) {
					...
					$('#viewReply > tbody:last').append('<tr><td>'+ writer +' </td><td>' + cmnt_content + '</td><td>'+ reg_date + '</td></tr>');
				});
			},
			error : function(e) {
...
<div class="w3-main w3-white" style="padding:80px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">실종동물 상세 페이지</h2>
<!-- 사진 슬라이드 영역 -->    
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      <div class="w3-col s6">
        ...
        <p><i class="fa fa-check-square-o"></i> 체중 : ${pboardDto.petsize }</p>
      </div>
      <div class="w3-col s6">
        <p><i class="fa fa-check-square-o"></i> 성별: ${pboardDto.gender }</p>
        <p><i class="fa fa-check-square-o"></i> 특징 : ${pboardDto.feature }</p>
...
<!-- 댓글창 시작 -->    
  ...
  <tbody></tbody>
    ...
    <p><textarea id="reply_content" name="reply_content" rows="4" cols="50"></textarea> </p>
	 <p><button class="w3-button w3-green w3-third" value="reply" id="addReply">댓글등록</button></p>
	  </c:if>
  </div>
  <hr>
<!-- 댓글창 끝 -->
