...
<div class="container allDiv">
	...
	<div class="w3-row-padding">
	  ...
	  <div class="w3-half">
	   ...
	   <div class="w3-half">
	    <label>성별</label>
	    <input class="w3-input" type="text" id="gender" name="gender" placeholder="성별을 입력해주세요">
	  </div>
	  ...
	  <div class="w3-half">
	    <label>체중</label>
	    <input class="w3-input" type="text" id="petsize" name="petsize" placeholder="실종된 동물의 체중을 입력해주세요">
	  </div>
	  <div class="w3-half">
	    <label>특징</label>
