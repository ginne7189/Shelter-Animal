...
<div>
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-body">${board_title}</div>
		</div>
		<table class="table">
			<tr>
			...
			<c:forEach items="${list}" var="data" varStatus="idx">
				<tr>
					...
					<td>
						...
						<c:if test="${!empty data.file1}"> - <i class="fa fa-file" aria-hidden="true"></i>
						</c:if>
					</td>
					<td align="center">
						<c:out value="${data.member_nick}" />
					</td>
		...
		<div>
			<button type="button" class="btn btn-success" onclick="location.href='boardWrite?board_id=${param.board_id}';">
