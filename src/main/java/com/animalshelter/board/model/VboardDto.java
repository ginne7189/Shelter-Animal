...
public class VboardDto extends BoardDto{
	...
	private String volunteerdate_end;
	public int getSeq() {
		return seq;
	}
	...
	public String getVolunteerdate_end() {
		return volunteerdate_end;
	}
	public void setVolunteerdate_end(String volunteerdate_end) {
		this.volunteerdate_end = volunteerdate_end;
	}
